...
TARGET_API = ENV.fetch('TARGET_API', 36)
TEAK_CREDENTIALS = {
  'dev' => {
    ...
    teak_gcm_sender_id: '271311759137',
    teak_firebase_project_id: 'teak-sdk-test-c3bf7',
    teak_firebase_app_id: '1:271311759137:android:f199517707f3ce862e4060',
    teak_firebase_api_key: 'AIzaSyAzBOa2X1aOWQaesIJGH0V_nY2AF36hfUg',
...
namespace :package do
  ...
  task copy: [:clean] do
    fastlane 'sdk', env: { FL_TEAK_SDK_SOURCE: ENV.fetch('FL_TEAK_SDK_SOURCE', "#{PROJECT_PATH}/../teak-unity/") }
  end
