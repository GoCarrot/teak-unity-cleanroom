...
#if USE_UNITY_IAP && !UNITY_PURCHASING_V5 && (UNITY_FACEBOOK || !UNITY_WEBGL)
...
#elif USE_UNITY_IAP && !UNITY_PURCHASING_V5 && (UNITY_FACEBOOK || !UNITY_WEBGL)
        {
            Button button = this.CreateButton("Test Purchase");
            button.onClick.AddListener(() => {
...
#endif // USE_UNITY_IAP && !UNITY_PURCHASING_V5 && (UNITY_FACEBOOK || !UNITY_WEBGL)
}
